  ...
  return (
    <main className="min-h-screen bg-[#EAE8E1] dark:bg-[#1a1a1a] flex items-center justify-center p-6 font-montserrat transition-colors duration-500">
      <div className="w-full max-w-md">
        <Link href="/" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest opacity-50 hover:opacity-100 transition-opacity mb-12">
        ...
        <div className="bg-white dark:bg-black/20 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 rounded-[3rem] p-10 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-neutral-500 mt-2 font-medium">Login to your Bento Hub account</p>
          </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-xs text-neutral-500 font-medium">
              ...
              <Link href="/register" className="text-[#1a1a1a] dark:text-[#EAE8E1] font-bold hover:underline">
                Register here
              </Link>
            </p>
          </div>
